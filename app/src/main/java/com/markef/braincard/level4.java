...
public class level4 extends AppCompatActivity {
    ...
    final int[] drawable = new int[]{R.drawable.carta19,R.drawable.carta20,R.drawable.carta21,R.drawable.carta22,R.drawable.carta23,R.drawable.carta24};
                ...
                if(currentPos <0){
                    ...
                    if(currentPos == position){
                        ...
                        if(countPair==6){
                            ...
                            success.start();
                            startActivity(new Intent(level4.this, MainActivity.class));
                        }
                    }
                    currentPos = -1;
                }
